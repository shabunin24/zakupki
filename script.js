...
// Конфигурация бота
const botToken = window.BOT_CONFIG?.token || '8203311811:AAEbVoeZ0inIO7CUFuGUbwNRdoL2xfpx/Pw';
...
const mockPurchases = [
    ...
    {
        id: 6,
        number: "0128300000123000006",
        title: "Поставка лакокрасочных материалов и строительных смесей",
        price: 1200000,
        currency: "RUB",
        customer: "Управление капитального строительства",
        region: "Москва",
        deadline: "2024-12-10",
        status: "active",
        category: "Товары",
        subcategory: "Строительные материалы",
        description: "Поставка красок, лаков, грунтовок, шпаклевок и других лакокрасочных материалов для ремонтных работ",
        documents: ["Техническое задание.pdf", "Спецификация.xlsx", "Сертификаты качества.pdf"],
        contacts: {
            phone: "+7 (495) 987-65-43",
            email: "stroymat@mos.ru",
            contact: "Краскин К.К."
        }
    },
    {
        id: 7,
        number: "0128300000123000007",
        title: "Услуги по покраске и отделке помещений",
        price: 2500000,
        currency: "RUB",
        ...
        status: "active",
        category: "Услуги",
        subcategory: "Отделочные работы",
        description: "Выполнение малярных работ, покраска стен, потолков, поклейка обоев в административных зданиях",
        documents: ["Договор подряда.pdf", "Технологическая карта.pdf", "Смета работ.xlsx"],
        contacts: {
            phone: "+7 (812) 876-54-32",
            email: "otdelka@spb.ru",
            contact: "Маляр М.М."
        }
    }
];
...
// Показ помощи
function showHelp() {
    alert('Помощь по использованию приложения:\n\n' +
          '🏠 Главная - основная информация и быстрые действия\n' +
          '🔍 Поиск - поиск закупок по ключевым словам и фильтрам\n' +
          '⭐ Избранное - ваши сохраненные закупки\n' +
